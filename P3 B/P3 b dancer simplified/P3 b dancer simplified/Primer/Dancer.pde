...
void showDancer(pt LeftFoot, float transfer, pt RightFoot, vec Forward)
 ...
 // ANKLES
  ...
  //TORSO Testing
  pt torsoCenter = P(BodyTorso, hipSpread, Up);
  pt torsoCenter2 = P(BodyTorso2, hipSpread, Up);
  fill(blue); sphere(torsoCenter, hipRadius);
  capletSection(torsoCenter, hipRadius, Pelvis, pelvisRadius);
  capletSection(torsoCenter2, hipRadius, torsoCenter, hipRadius);
  //capletSection(
